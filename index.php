                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <form action="" method="post">
                            ...
                            <p><a href="forgot-password.php" style="margin-bottom: 15px; display: block; text-align: right;  color:darkcyan;">Mot de passe oublié?</a></p>
                            <button name="submit" name="submit" class="btn" type="submit"  style="background:darkcyan;">Se connecter</button>
                        </form>
                        <div class="social-icons">
                            <p>Créer un compte! <a href="register.php">S'inscrire</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
